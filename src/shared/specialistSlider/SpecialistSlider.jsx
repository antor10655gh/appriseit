    ...
    <>
      ...
      >
        {specialists.map((specialist) => (
          <SwiperSlide>
            <div>
              <div class="img-hover-zoom relative group cursor-pointer">
                <img src={specialist.img} alt="Specialist" className="w-full" />
                <div
                  className="absolute flex justify-center items-center -bottom-24 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-1/3 p-5 hidden group-hover:block transition duration-300"
                  style={styleDiv}
                >
